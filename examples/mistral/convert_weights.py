...
def get_weight_mapping(config: NanotronMistralConfig, nt_to_hf: bool = True) -> dict[str, str]:
...
def load_nanotron_model(
    ...
    config_cls: Optional[NanotronConfigs] = NanotronMistralConfig,
) -> MistralForTraining:
    """
    ...
    if config_cls == NanotronMistralConfig:
        ...
        raise ValueError(f"Unsupported model config class: {config_cls}")
